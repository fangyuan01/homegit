...
public class ShopDao extends AbstractDao<Shop, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property ShopImgPath = new Property(2, String.class, "shopImgPath", false, "SHOP_IMG_PATH");
        public final static Property ShopPhone = new Property(3, String.class, "shopPhone", false, "SHOP_PHONE");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'SHOP' (" + //
                ...
                "'SHOP_IMG_PATH' TEXT," + // 2: shopImgPath
                "'SHOP_PHONE' TEXT);"); // 3: shopPhone
    }
    ...
    protected void bindValues(SQLiteStatement stmt, Shop entity) {
        ...
        String shopImgPath = entity.getShopImgPath();
        if (shopImgPath != null) {
            stmt.bindString(3, shopImgPath);
        }
 
        String shopPhone = entity.getShopPhone();
        if (shopPhone != null) {
            stmt.bindString(4, shopPhone);
        }
    }
    ...
    public Shop readEntity(Cursor cursor, int offset) {
        Shop entity = new Shop( //
            ...
            cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2), // shopImgPath
            cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3) // shopPhone
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Shop entity, int offset) {
        ...
        entity.setShopImgPath(cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2));
        entity.setShopPhone(cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3));
     }
