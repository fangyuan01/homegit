...
public class WeatherInfo {
	...
	public Integer img8;
	public Integer img9;
	public Integer img10;
	public Integer img11;
	public Integer img12;

	public Integer img_single;
	// img对应的文字说明 "多云"
	...
	public String fl5;
	public String fl6;
	// 这里的这些生活指数也是和上面的更新点有关系 18点左右更新的就是明天的生活指数了
	// 舒适度指数， "冷"
	public String index;
	// 穿衣指数
	public String index_d;// "天气冷，建议着棉服、羽绒服、皮夹克加羊毛衫等冬季服装。年老体弱者宜着厚棉衣、冬大衣或厚羽绒服。",
	// 48小时内，舒适度指数
	public String index48; // "冷",
	// 48小时内穿衣指数
	public String index48_d; // "天气冷，建议着棉服、羽绒服、皮夹克加羊毛衫等冬季服装。年老体弱者宜着厚棉衣、冬大衣或厚羽绒服。"

	public String index_uv;// 紫外线指数 "中等",
	public String index48_uv;// 48小時內紫外线指数 "中等",
	public String index_xc;// 洗车指数，"适宜",
	public String index_tr;// 旅游指数 "适宜",
	public String index_co;// //舒适度指数 "较舒适",

	public String st1;// "9",
	public String st2;// "-3",
	public String st3;// "12",
	public String st4;// "0",
	public String st5;// "14",
	public String st6;// "2",

	public String index_cl;// 晨练指数 "不宜",
	public String index_ls;// 晾晒指数 "基本适宜",
	public String index_ag;// 息斯敏过敏气象指数 "极不易发"
	...
	public void setFchh(Integer fchh) {
		this.fchh = fchh;
	}
	...
	public Integer getImg4() {
		return img4;
	}

	public void setImg4(Integer img4) {
		this.img4 = img4;
	}

	public Integer getImg5() {
		return img5;
	}

	public void setImg5(Integer img5) {
		this.img5 = img5;
	}

	public Integer getImg6() {
		return img6;
	}

	public void setImg6(Integer img6) {
		this.img6 = img6;
	}

	public Integer getImg7() {
		return img7;
	}

	public void setImg7(Integer img7) {
		this.img7 = img7;
	}

	public Integer getImg8() {
		return img8;
	}

	public void setImg8(Integer img8) {
		this.img8 = img8;
	}

	public Integer getImg9() {
		return img9;
	}

	public void setImg9(Integer img9) {
		this.img9 = img9;
	}

	public Integer getImg10() {
		return img10;
	}

	public void setImg10(Integer img10) {
		this.img10 = img10;
	}

	public Integer getImg11() {
		return img11;
	}

	public void setImg11(Integer img11) {
		this.img11 = img11;
	}

	public Integer getImg12() {
		return img12;
	}

	public void setImg12(Integer img12) {
		this.img12 = img12;
	}

	public Integer getImg_single() {
		return img_single;
	}

	public void setImg_single(Integer img_single) {
