...
public class CourseDao extends AbstractDao<Course, Long> {
    ...
    */
    public static class Properties {
        public final static Property CourseNum = new Property(0, Long.class, "courseNum", true, "COURSE_NUM");
        ...
        public final static Property CourseTime = new Property(4, String.class, "courseTime", false, "COURSE_TIME");
        public final static Property ClassRoom = new Property(5, String.class, "classRoom", false, "CLASS_ROOM");
    };
    ...
    public void readEntity(Cursor cursor, Course entity, int offset) {
        entity.setCourseNum(cursor.isNull(offset + 0) ? null : cursor.getLong(offset + 0));
        ...
        entity.setCourseTime(cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4));
